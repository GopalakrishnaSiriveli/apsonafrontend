...
async function fetchNotesByUser() {
    try {
        ...
        const response = await fetch('https://apsonabackend.onrender.com/notes/api/user/note', {
            method: 'GET',
            headers: {
...
async function archiveNote(noteId) {
    ...
    try {
        ...
        const response = await fetch(`https://apsonabackend.onrender.com/notes/${noteId}`, {
            method: 'PATCH',
            headers: {
                'Authorization': `Bearer ${token}`,
...
async function deleteNote(noteId) {
    ...
    try {
        ...
        const response = await fetch(`https://apsonabackend.onrender.com/notes/deletenotes/${noteId}`, {
            method: 'DELETE',
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
...
async function updateNoteOnServer() {
    try {
        ...
        const response = await fetch(`https://apsonabackend.onrender.com/notes/${updateId}`, {
            method: 'PATCH',
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
...
addBtn.addEventListener('click', async (e) => {
    ...
    try {
        ...
        const response = await fetch('https://apsonabackend.onrender.com/notes/add', {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
